...
if (-not $SkipRustBuild) {
    ...
    $crates = @(
        ...
        @{ Path = 'hooks\copilot';                  Name = 'Copilot interceptor (experimental)' },
...
Copy-Item (Find-Artifact (Join-Path $RootDir 'hooks\copilot') 'copilot-interceptor.exe') (Join-Path $StageDir 'bin\') -Force
